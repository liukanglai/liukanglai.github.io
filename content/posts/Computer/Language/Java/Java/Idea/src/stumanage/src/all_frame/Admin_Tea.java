...
import extra_frame.TeaAlter;
import extra_frame.TeaDel;

public class Admin_Tea extends JFrame implements ActionListener
{
    JButton bDetele=new JButton("删除教师信息");
    JButton bAdd=new JButton("添加教师信息");
    JButton bAlter=new JButton("修改教师信息");
