...
public class TeaAdd extends JFrame implements ActionListener
{
    ...
    public TeaAdd()
    {
        ...
        JLabel l5=new JLabel("              性别(M=男;F=女)");
    ...
    public boolean Check(String num1)
    {
        ...
        String sql="select * from DB_Teacher where TeacherID = '"+num1+"' ";
...
//                	if(!Check(class1,num1))
//                    {
//                        JOptionPane.showMessageDialog(null, "不存在，请添加该课程信息！", "警告",
//                                                      JOptionPane.ERROR_MESSAGE);
//                        this.dispose();
//                        new TeaAdd();
//                    }              	
...
//                        }
                    ...
                    {
                        e1.printStackTrace();
                        JOptionPane.showMessageDialog(null, "某些信息不符合要求！请重新输入！", "警告",
                                                      JOptionPane.ERROR_MESSAGE);
                    }
                    finally
                    {
